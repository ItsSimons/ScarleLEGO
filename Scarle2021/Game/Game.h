...
private:
    ...
    //Scarle Added stuff
    GameData* m_GD = nullptr;			//Data to be shared to all Game Objects as they are ticked
    DrawData* m_DD = nullptr;			//Data to be shared to all 3D Game Objects as they are drawn
    DrawData2D* m_DD2D = nullptr;	    //Data to be passed by game to all 2D Game Objects via Draw 
    ...
    //LEGO Component 
    std::unique_ptr<LEGO::Handler> m_legoComponent = nullptr;
};
